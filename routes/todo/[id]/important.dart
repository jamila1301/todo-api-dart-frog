...
Future<Response> onRequest(
  ...
  return switch (context.request.method) {
    HttpMethod.patch => _markAsImportant(context, id),
    _ => Future.value(Response(statusCode: HttpStatus.methodNotAllowed)),
  };
}

Future<Response> _markAsImportant(RequestContext context, String id) async {
  try {
    final completedTodo = await context.read<TodoService>().markAsImportant(id);
